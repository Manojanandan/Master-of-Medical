...
export const clearCart = async(cartId) =>{
    return await instance.post(`cart/clear-cart/${cartId}`)
}
...
export const getOrderById = async(orderId) =>{
    return await instance.get(`order/get-vendor-order/${orderId}`);
}

export const updateVendorOrder = async(orderData) =>{
    return await instance.put('order/update-vendor-order', orderData);
}
