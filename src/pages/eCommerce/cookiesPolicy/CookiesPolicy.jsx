  ...
  return (
    <Box sx={{height:'auto',width:'100%',}}>
        ...
        <Box sx={{height:'100%',width:'90%',margin:'2% auto'}}>
            ...
            <Typography variant='p' sx={{fontSize:'16px',}}>By continuing to use our website www.medikabazaar.com (the "Site") and Medikabazaar mobile app (the "app"), you agree that we can store and place cookies on your computer and mobile device to improve your site and app experience. This Cookie Policy covers the information practices of our websites, including how Medikabazaar collects, uses, shares and secures the personal information you provide. If you use our websites, we may use various website navigation information including tracking technologies such as cookies and web beacons to collect and store information from you. You are requested to read this cookie policy for more details about the cookies that are placed when you are using this Site.</Typography>
