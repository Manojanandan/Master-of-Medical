  ...
  return (
    <div className={styles.addressesContainer}>
      ...
      <div className={styles.contentHeader}>
        <h1 className={styles.contentTitle}>Addresses</h1>
      ...
      <div className={styles.addAddressSection}>
        ...
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className={styles.addIcon}>
                ...
                <div className={styles.addressHeader}>
                  ...
                  <div className={styles.addressActions}>
                    <button
                      ...
                      title="Edit Address"
                    >
                      <svg viewBox="0 0 24 24" fill="currentColor" className={styles.editIcon}>
                    ...
                    >
                      <svg viewBox="0 0 24 24" fill="currentColor" className={styles.deleteIcon}>
