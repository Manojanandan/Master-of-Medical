    ...
    <React.Fragment>
      <Box sx={{ height: 'auto', width: '100%', margin: '3% 0', }}>
        ...
        <Box sx={{ height: 'auto', width: '95%', margin: '1% auto', display: 'flex', flexWrap: 'wrap', }}>
          <Box sx={{ height: 'auto', width: '330px', border: 'solid 1.5px #2424', borderRadius: '10px', margin: '0 1% 1.5% 0' }}>
        ...
        <Box sx={{ height: 'auto', width: '95%', margin: '1% auto', display: 'flex', flexWrap: 'wrap',}}>
          ...
          <Box sx={{ height: 'auto', width: '680px'}}>
            <Box sx={{ height: '440px', width: '100%', display: 'flex', padding: '10px 0 0', border: 'solid 1.5px #2424', borderRadius: '10px'}}>
